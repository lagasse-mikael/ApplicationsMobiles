...
class AmusementFragment: Fragment(R.layout.fragment_fun) {

    private val binding : FragmentFunBinding by viewBinding()
    private val viewModel : AmusementViewModel by viewModels()
    ...
    override fun onViewCreated(view: View,savedInstanceState: Bundle?) {
        ...
        mediaPlayer = MediaPlayer.create(requireContext(),R.raw.sfx)

        try{
            val videoURI = Uri.parse("android.resource://${requireActivity().packageName}/${R.raw.videoplayback}")
