...
class UserRepository(private val context:Context) {
    object PreferencesKey {
        ...
        val ONLINE_STATE = booleanPreferencesKey("is_online")
    }
    ...
    val user: Flow<User> = context.dataStore.data.map { preferences ->
        ...
        val onlineStatus = preferences[PreferencesKey.ONLINE_STATE] ?: false

        User(firstName,lastName,onlineStatus)
    }
    ...
    suspend fun save(firstName:String,lastName:String,isOnline:Boolean) {
        context.dataStore.edit { preferences ->
            ...
            preferences[PreferencesKey.ONLINE_STATE] = isOnline
        }
    }
}